...
class EditMeal extends Component {
    ...
    componentDidMount() {
        ...
        if(!localStorage.token)
            ...
            axios
                .get("/meals/edit/" + this.props.match.params.id)
                .then(res => {
                    this.setState({
    ...
    onSubmit = event => {
        ...
        axios
            .post("/meals/edit/" + this.props.match.params.id, newMeal)
            .then(res => {
                console.log("Input data: " + res.data);

                // Redirect to home page after meal being successfully edited
                ...
                <div className="form-row">
                    <div className="m-auto col-md-7">
                        ...
                        <div className="col s14">
                            <h3 className="display-4 h3 mb-3 font-weight-normal">Edit Your Meal</h3>
                        </div>
                        <form onSubmit={this.onSubmit}>
                            ...
                            <br/>
                            <input type="submit" className="btn btn-large btn-secondary waves-light" value="Update"/>
                        </form>
                    </div>
                </div>
            </div>
